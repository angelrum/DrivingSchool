...
VALUES ('123456', 'Москва', 'Москва', 'ул. Первого Мая', 'д.12', 1, '105'),
       ('123456', 'Москва', 'Москва', 'ул. Первого Мая', 'д.15', 1, '117'),
       ('123457', 'Москва', 'Москва', 'ул. Ленина', 'д.15', 3, '305'),
       ('123458', 'Москва', 'Москва', 'ул. Нижняя Красносельская', 'д.15', 3, '343'),
       ('123459', 'Москва', 'Москва', 'ул. Антонова', 'д.1', 2, '283'),
       ('123459', 'Москва', 'Москва', 'ул. Миронова', 'д.3', 2, '15');
...
VALUES ('+7(911)111-11-11', true, '12345', 'Иван', 'Иванов', 'Иванович', 'admin1@test.ru', true, true, 0, null), -- админ ООО "Рога и копыта"
       ...
       ('+7(911)111-11-13', true, '123457', 'Сергей', 'Петров', 'Иванович', 'teacher1@test.ru', true, true, 0, 1000),
       ('+7(911)111-11-14', true, '123458', 'Петр', 'Петров', 'Иванович', 'teacher2@test.ru', true, true, 0, 1000),
       -- учитель в ООО "Новые рога"
       ('+7(911)111-11-15', true, '123459', 'Виктор', 'Иванов', 'Иванович', 'teacher1@test1.ru', true, true, 0, 1001),
       -- ученики в ООО "Рога и копыта"
       ('+7(911)211-11-11', true, '12345', 'Артем', 'Антонов', 'Иванович', 'student1@test1.ru', true, true, 0, 1000),
       ('+7(911)211-11-12', true, '123456', 'Иван', 'Антонов', 'Иванович', 'student2@test1.ru', true, true, 0, 1000),
       ('+7(911)211-11-13', true, '1234567', 'Иван', 'Антонов', 'Иванович', 'student3@test1.ru', true, true, 0, 1000),
       -- ученики в ООО "Новые рога"
       ('+7(911)211-11-14', true, '12345678', 'Сергей', 'Антонов', 'Иванович', 'student4@test1.ru', true, true, 0, 1001);
